 ...
 * @hidden Described in the {@link OpenCVImageProps['contentFit']}
 */
 ...
 * @hidden Described in the {@link OpenCVImageProps['decodeFormat']}
 */
 ...
 */
export interface OpenCVImageProps extends Omit<
  ViewProps,
  "style" | "children"
> {
  /** @hidden */
 ...
 * @hidden
 */
export interface NativeImageViewProps extends OpenCVImageProps {
  style?: RNImageStyle;
  ...
  nativeViewRef?: React.RefObject<NativeImageView | null>;
 ...
 */
export type ImageContentPositionValue =
  | number
  | string
  | `${number}%`
  | `${number}`
 ...
 */
export interface OpenCVImageBackgroundProps extends Omit<
  OpenCVImageProps,
  "style"
> {
