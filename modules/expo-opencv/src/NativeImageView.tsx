...
const NativeImageView = requireNativeViewManager("ExpoOpenCV");
...
class NativeImageViewWrapper extends React.PureComponent<NativeImageViewProps> {
...
export default NativeImageViewWrapper;
